...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $ingredients = [
            ['id' => 1, 'name' => 'Alma', 'isFruit' => true, 'kcalPerGram' => 78.0, 'unit' => 'db'],
            ['id' => 2, 'name' => 'Banán', 'isFruit' => true, 'kcalPerGram' => 105.0, 'unit' => 'db'],
            ['id' => 3, 'name' => 'Csirkemell', 'isFruit' => false, 'kcalPerGram' => 1.20, 'unit' => 'g'],
            ['id' => 4, 'name' => 'Rizs', 'isFruit' => false, 'kcalPerGram' => 3.50, 'unit' => 'g'],
            ['id' => 5, 'name' => 'Paradicsom', 'isFruit' => false, 'kcalPerGram' => 22.0, 'unit' => 'db'],
            ['id' => 6, 'name' => 'Tojás', 'isFruit' => false, 'kcalPerGram' => 78.0, 'unit' => 'db'],
            ['id' => 7, 'name' => 'Liszt', 'isFruit' => false, 'kcalPerGram' => 3.40, 'unit' => 'g'],
            ['id' => 8, 'name' => 'Cukor', 'isFruit' => false, 'kcalPerGram' => 3.87, 'unit' => 'g'],
            ['id' => 9, 'name' => 'Narancs', 'isFruit' => true, 'kcalPerGram' => 62.0, 'unit' => 'db'],
            ['id' => 10, 'name' => 'Eper', 'isFruit' => true, 'kcalPerGram' => 0.33, 'unit' => 'g'],
            ['id' => 11, 'name' => 'Körte', 'isFruit' => true, 'kcalPerGram' => 102.0, 'unit' => 'db'],
            ['id' => 12, 'name' => 'Brokkoli', 'isFruit' => false, 'kcalPerGram' => 135.0, 'unit' => 'db'],
            ['id' => 13, 'name' => 'Sárgarépa', 'isFruit' => false, 'kcalPerGram' => 25.0, 'unit' => 'db'],
            ['id' => 14, 'name' => 'Vöröshagyma', 'isFruit' => false, 'kcalPerGram' => 40.0, 'unit' => 'db'],
            ['id' => 15, 'name' => 'Fokhagyma', 'isFruit' => false, 'kcalPerGram' => 5.0, 'unit' => 'db'],
            ['id' => 16, 'name' => 'Tej', 'isFruit' => false, 'kcalPerGram' => 0.42, 'unit' => 'ml'],
            ['id' => 17, 'name' => 'Tejföl', 'isFruit' => false, 'kcalPerGram' => 2.04, 'unit' => 'g'],
            ['id' => 18, 'name' => 'Sajt', 'isFruit' => false, 'kcalPerGram' => 3.50, 'unit' => 'g'],
            ['id' => 19, 'name' => 'Marhahús', 'isFruit' => false, 'kcalPerGram' => 2.50, 'unit' => 'g'],
            ['id' => 20, 'name' => 'Lazac', 'isFruit' => false, 'kcalPerGram' => 2.08, 'unit' => 'g'],
            ['id' => 21, 'name' => 'Tonhal', 'isFruit' => false, 'kcalPerGram' => 1.30, 'unit' => 'g'],
            ['id' => 22, 'name' => 'Zabpehely', 'isFruit' => false, 'kcalPerGram' => 3.80, 'unit' => 'g'],
            ['id' => 23, 'name' => 'Méz', 'isFruit' => false, 'kcalPerGram' => 3.04, 'unit' => 'g'],
            ['id' => 24, 'name' => 'Olívaolaj', 'isFruit' => false, 'kcalPerGram' => 8.84, 'unit' => 'ml'],
            ['id' => 25, 'name' => 'Paprika', 'isFruit' => false, 'kcalPerGram' => 31.0, 'unit' => 'db'],
            ['id' => 26, 'name' => 'Uborka', 'isFruit' => false, 'kcalPerGram' => 40.0, 'unit' => 'db'],
            ['id' => 27, 'name' => 'Gomba', 'isFruit' => false, 'kcalPerGram' => 0.22, 'unit' => 'g'],
            ['id' => 28, 'name' => 'Krumpli', 'isFruit' => false, 'kcalPerGram' => 115.0, 'unit' => 'db'],
            ['id' => 29, 'name' => 'Tejsavó fehérje', 'isFruit' => false, 'kcalPerGram' => 3.90, 'unit' => 'g'],
            ['id' => 30, 'name' => 'Mandula', 'isFruit' => false, 'kcalPerGram' => 5.79, 'unit' => 'g'],
            ['id' => 31, 'name' => 'Joghurt natúr', 'isFruit' => false, 'kcalPerGram' => 0.61, 'unit' => 'g'],
            ['id' => 32, 'name' => 'Görög joghurt', 'isFruit' => false, 'kcalPerGram' => 0.95, 'unit' => 'g'],
            ['id' => 33, 'name' => 'Vaj', 'isFruit' => false, 'kcalPerGram' => 7.17, 'unit' => 'g'],
            ['id' => 34, 'name' => 'Margarin', 'isFruit' => false, 'kcalPerGram' => 5.20, 'unit' => 'g'],
            ['id' => 35, 'name' => 'Teljes kiőrlésű kenyér', 'isFruit' => false, 'kcalPerGram' => 95.0, 'unit' => 'db'],
            ['id' => 36, 'name' => 'Fehér kenyér', 'isFruit' => false, 'kcalPerGram' => 105.0, 'unit' => 'db'],
            ['id' => 37, 'name' => 'Sonka', 'isFruit' => false, 'kcalPerGram' => 1.20, 'unit' => 'g'],
            ['id' => 38, 'name' => 'Pulykamell', 'isFruit' => false, 'kcalPerGram' => 1.10, 'unit' => 'g'],
            ['id' => 39, 'name' => 'Bacon', 'isFruit' => false, 'kcalPerGram' => 65.0, 'unit' => 'db'],
            ['id' => 40, 'name' => 'Kolbász', 'isFruit' => false, 'kcalPerGram' => 3.80, 'unit' => 'g'],
            ['id' => 41, 'name' => 'Túró', 'isFruit' => false, 'kcalPerGram' => 1.10, 'unit' => 'g'],
            ['id' => 42, 'name' => 'Tejszín', 'isFruit' => false, 'kcalPerGram' => 2.90, 'unit' => 'ml'],
            ['id' => 43, 'name' => 'Kakaópor', 'isFruit' => false, 'kcalPerGram' => 2.30, 'unit' => 'g'],
            ['id' => 44, 'name' => 'Csokoládé ét', 'isFruit' => false, 'kcalPerGram' => 5.40, 'unit' => 'g'],
            ['id' => 45, 'name' => 'Csokoládé tej', 'isFruit' => false, 'kcalPerGram' => 5.30, 'unit' => 'g'],
            ['id' => 46, 'name' => 'Citrom', 'isFruit' => true, 'kcalPerGram' => 29.0, 'unit' => 'db'],
            ['id' => 47, 'name' => 'Lime', 'isFruit' => true, 'kcalPerGram' => 20.0, 'unit' => 'db'],
            ['id' => 48, 'name' => 'Avokádó', 'isFruit' => true, 'kcalPerGram' => 270.0, 'unit' => 'db'],
            ...
            ['id' => 51, 'name' => 'Mogyoróvaj', 'isFruit' => false, 'kcalPerGram' => 5.90, 'unit' => 'g'],
            ['id' => 52, 'name' => 'Dió', 'isFruit' => false, 'kcalPerGram' => 6.54, 'unit' => 'g'],
            ['id' => 53, 'name' => 'Kesudió', 'isFruit' => false, 'kcalPerGram' => 5.53, 'unit' => 'g'],
            ['id' => 54, 'name' => 'Lencse', 'isFruit' => false, 'kcalPerGram' => 3.40, 'unit' => 'g'],
            ['id' => 55, 'name' => 'Csicseriborsó', 'isFruit' => false, 'kcalPerGram' => 3.60, 'unit' => 'g'],
            ['id' => 56, 'name' => 'Vörös bab', 'isFruit' => false, 'kcalPerGram' => 3.30, 'unit' => 'g'],
            ['id' => 57, 'name' => 'Borsó', 'isFruit' => false, 'kcalPerGram' => 0.81, 'unit' => 'g'],
            ['id' => 58, 'name' => 'Spenót', 'isFruit' => false, 'kcalPerGram' => 0.23, 'unit' => 'g'],
            ['id' => 59, 'name' => 'Saláta', 'isFruit' => false, 'kcalPerGram' => 30.0, 'unit' => 'db'],
            ['id' => 60, 'name' => 'Cukkini', 'isFruit' => false, 'kcalPerGram' => 50.0, 'unit' => 'db'],
            ['id' => 61, 'name' => 'Padlizsán', 'isFruit' => false, 'kcalPerGram' => 85.0, 'unit' => 'db'],
            ['id' => 62, 'name' => 'Kukorica', 'isFruit' => false, 'kcalPerGram' => 0.90, 'unit' => 'g'],
            ['id' => 63, 'name' => 'Ketchup', 'isFruit' => false, 'kcalPerGram' => 1.00, 'unit' => 'g'],
            ['id' => 64, 'name' => 'Majonéz', 'isFruit' => false, 'kcalPerGram' => 6.80, 'unit' => 'g'],
            ['id' => 65, 'name' => 'Mustár', 'isFruit' => false, 'kcalPerGram' => 0.70, 'unit' => 'g'],
            ['id' => 66, 'name' => 'Szójaszósz', 'isFruit' => false, 'kcalPerGram' => 0.60, 'unit' => 'ml'],
            ['id' => 67, 'name' => 'Tészta (száraz)', 'isFruit' => false, 'kcalPerGram' => 3.60, 'unit' => 'g'],
            ['id' => 68, 'name' => 'Bulgur', 'isFruit' => false, 'kcalPerGram' => 3.42, 'unit' => 'g'],
            ['id' => 69, 'name' => 'Quinoa', 'isFruit' => false, 'kcalPerGram' => 3.65, 'unit' => 'g'],
            ...
            ['id' => 74, 'name' => 'Ananász', 'isFruit' => true, 'kcalPerGram' => 450.0, 'unit' => 'db'],
            ['id' => 75, 'name' => 'Mangó', 'isFruit' => true, 'kcalPerGram' => 190.0, 'unit' => 'db'],
            ['id' => 76, 'name' => 'Szőlő', 'isFruit' => true, 'kcalPerGram' => 0.67, 'unit' => 'g'],
            ['id' => 77, 'name' => 'Datolya', 'isFruit' => true, 'kcalPerGram' => 28.0, 'unit' => 'db'],
            ['id' => 78, 'name' => 'Mazsola', 'isFruit' => true, 'kcalPerGram' => 3.00, 'unit' => 'g'],
            ['id' => 79, 'name' => 'Füge', 'isFruit' => true, 'kcalPerGram' => 37.0, 'unit' => 'db'],
            ['id' => 80, 'name' => 'Kivi', 'isFruit' => true, 'kcalPerGram' => 42.0, 'unit' => 'db'],
            ['id' => 81, 'name' => 'Zöldbab', 'isFruit' => false, 'kcalPerGram' => 0.31, 'unit' => 'g'],
            ['id' => 82, 'name' => 'Karfiol', 'isFruit' => false, 'kcalPerGram' => 125.0, 'unit' => 'db'],
            ['id' => 83, 'name' => 'Kelbimbó', 'isFruit' => false, 'kcalPerGram' => 0.43, 'unit' => 'g'],
            ['id' => 84, 'name' => 'Vöröskáposzta', 'isFruit' => false, 'kcalPerGram' => 0.31, 'unit' => 'g'],
            ['id' => 85, 'name' => 'Fejes káposzta', 'isFruit' => false, 'kcalPerGram' => 200.0, 'unit' => 'db'],
            ['id' => 86, 'name' => 'Cékla', 'isFruit' => false, 'kcalPerGram' => 65.0, 'unit' => 'db'],
            ['id' => 87, 'name' => 'Édesburgonya', 'isFruit' => false, 'kcalPerGram' => 170.0, 'unit' => 'db'],
            ['id' => 88, 'name' => 'Hajdina', 'isFruit' => false, 'kcalPerGram' => 3.40, 'unit' => 'g'],
            ['id' => 89, 'name' => 'Kuszkusz', 'isFruit' => false, 'kcalPerGram' => 3.60, 'unit' => 'g'],
            ['id' => 90, 'name' => 'Rizstej', 'isFruit' => false, 'kcalPerGram' => 0.47, 'unit' => 'ml'],
            ['id' => 91, 'name' => 'Mandulatej', 'isFruit' => false, 'kcalPerGram' => 0.25, 'unit' => 'ml'],
            ['id' => 92, 'name' => 'Zabtej', 'isFruit' => false, 'kcalPerGram' => 0.45, 'unit' => 'ml'],
            ['id' => 93, 'name' => 'Kecskesajt', 'isFruit' => false, 'kcalPerGram' => 3.64, 'unit' => 'g'],
            ['id' => 94, 'name' => 'Feta sajt', 'isFruit' => false, 'kcalPerGram' => 2.64, 'unit' => 'g'],
            ['id' => 95, 'name' => 'Mozzarella', 'isFruit' => false, 'kcalPerGram' => 350.0, 'unit' => 'db'],
            ['id' => 96, 'name' => 'Ricotta', 'isFruit' => false, 'kcalPerGram' => 1.74, 'unit' => 'g'],
            ['id' => 97, 'name' => 'Pesto', 'isFruit' => false, 'kcalPerGram' => 4.50, 'unit' => 'g'],
            ['id' => 98, 'name' => 'Szezámmag', 'isFruit' => false, 'kcalPerGram' => 5.70, 'unit' => 'g'],
            ['id' => 99, 'name' => 'Chia mag', 'isFruit' => false, 'kcalPerGram' => 4.80, 'unit' => 'g'],
            ['id' => 100, 'name' => 'Lenmag', 'isFruit' => false, 'kcalPerGram' => 5.30, 'unit' => 'g'],
        ];
